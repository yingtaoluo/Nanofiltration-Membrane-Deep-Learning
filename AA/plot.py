...
aux_args.add_argument('--data', type=str, choices=['0', '1', '2', '3', '4', 's'],
...
if args.type == 'alone':
    ...
    # data directory
    dps = 'H:/interfacial_data/data' + '/' + args.data
    ...
    if args.choice == 'rejection':
        ...
        train_label = train_data[:, 444:445]
    else:
    ...
    if args.choice == 'rejection':
        ...
        valid_label = valid_data[:, 444:445]
    else:
        raise NotImplementedError()
    ...
    # the first figure
    plt.figure(1)
    plt.plot(train_label, train_label, color=color1, linestyle=":", label='real')
    plt.scatter(train_label, train_predict.detach().numpy(),
                c=color3, s=5, marker='o', label='predict')
    plt.legend(loc='lower right')
    ...
    # the second figure
    plt.figure(2)
    plt.plot(test_label, test_label, color=color1, linestyle=":", label='real')
    ...
    # the third figure
    plt.figure(3)
    plt.plot(valid_label, valid_label, color=color1, linestyle=":", label='real')
